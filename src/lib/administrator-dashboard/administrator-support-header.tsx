export default function AdminSupportHeader() {
  return (
      <div className="bg-[#F3F5FF] h-20 w-full">
        <h1 className="text-[28px] font-[600] pt-4 ml-52">Support</h1>
        <div className="absolute top-4.5 right-35 w-10 h-10">
          <img src="/Ellipse 68.png" alt="profile picture" />
        </div>
        <div className="flex flex-col absolute top-5.5 right-14 ">

      ...
      >
        ...
        <SidebarContent className="space-y-2 mt-7">
          <SidebarGroup
            ...
            className={`flex flex-row gap-2 pl-3 text-[14px] font-500 text-left cursor-pointer hover:bg-[#E1FFBB] hover:text-black ${
              isActive("/admin-reports") ? "bg-[#E1FFBB] text-black" : ""
            }`}
          >
          ...
          <SidebarGroup
            ...
            className={`flex flex-row gap-2 pl-3 text-[14px] font-500 text-left cursor-pointer hover:bg-[#E1FFBB] hover:text-black ${
              isActive("/admin-dashboard") ? "bg-[#E1FFBB] text-black" : ""
            }`}
          >
          ...
          <SidebarGroup
            ...
            className={`flex flex-row gap-2 pl-3 text-[14px] font-500 text-left cursor-pointer hover:bg-[#E1FFBB] hover:text-black ${
              isActive("/admin-settings") ? "bg-[#E1FFBB] text-black" : ""
            }`}
          >
          ...
          <SidebarGroup
            ...
            className={`flex flex-row gap-2 pl-3 text-[14px] font-500 text-left cursor-pointer hover:bg-[#E1FFBB] hover:text-black ${
              isActive("/admin-support") ? "bg-[#E1FFBB] text-black" : ""
            }`}
          >

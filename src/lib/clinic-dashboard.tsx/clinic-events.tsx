    ...
    <>
      <div className="flex-1 min-w-[400px] relative">
        ...
        <div className="flex flex-row">
          <div className="w-70 h-170 ml-4 mt-4 md:w-120 lg:w-66">
            ...
            <div className="flex flex-row gap-2 space-y-5">
              ...
              <h1 className="text-[14px] font-[400] sansfont">
                Mental Health Breaks Recommended
              </h1>
            </div>
            <div className="flex flex-row gap-2 space-y-5">
            ...
            <div className="flex flex-row gap-2 space-y-5">
              <div className="w-4 h-4 bg-[#162958] mt-0.5" />
              <h1 className="text-[14px] font-[400] sansfont">
            ...
            <div className="flex flex-row gap-2 w-55 relative mb-5">

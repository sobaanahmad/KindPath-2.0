...
export default function ClinicEvents() {
  return (
    <>
      <div className="w-130 h-170 ml-53 relative mb-16">
        <h1 className="font-[700] text-[16px] mt-3 ml-4 sansfont">Events</h1>
        <div className="flex flex-row">
          <div className="w-70 h-157 ml-4 mt-4">
            ...
            <div className="flex flex-row gap-2 space-y-5">
              ...
              <h1 className="text-[14px] font-[400] sansfont">988 Calls</h1>
            </div>
            <div className="flex flex-row gap-2 space-y-5">
              <div className="w-4 h-4 bg-[#DCBB9A] mt-0.5" />
              <h1 className="text-[14px] font-[400] sansfont">Mental Health Breaks Recommended</h1>
            </div>
            <div className="flex flex-row gap-2 space-y-5">
            ...
            <div className="flex flex-row gap-2 space-y-5">
              <div className="w-4 h-4 bg-[#074799] mt-0.5" />
              <h1 className="text-[14px] font-[400] sansfont">
                Warmline Calls Placed
              </h1>
            </div>
            <div className="flex flex-row gap-2 space-y-5">
              <div className="w-4 h-4 bg-[#25D255] mt-0.5" />
              <h1 className="text-[14px] font-[400] sansfont">
                Warmline Recommendations Made
              </h1>
            </div>
            <div className="flex flex-row gap-2 w-55 relative">
             ...
             <div className="flex flex-row gap-2 mt-5">
              <div className="w-4 h-4 bg-[#D18CD7] mt-0.5" />
              <h1 className="text-[14px] font-[400] sansfont">
                Recommendations Used
              </h1>
            </div>
            <div className="flex flex-row gap-2 w-55 relative mt-4">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="toolbox" className="border-none">
                  <AccordionTrigger className="flex items-start gap-[2px] p-0 hover:no-underline cursor-pointer">
          ...
          <div className="w-42 h-140 mt-4 ml-1">
            ...
            <div className="flex flex-row">
              <div className="flex flex-col gap-2 space-y-2 mt-3">
                ...
                <h1 className="text-[14px] font-[400] text-[#25D255] ml-2 flex flex-row gap-1 sansfont">
                  <ArrowUp className="size-3 mt-1.5" />
                  18% from last month
                </h1>
                ...
                <h1 className="text-[14px] font-[400] text-[#25D255] mt-0.5 ml-2 flex flex-row gap-1 sansfont">
